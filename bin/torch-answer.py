...
tokens_per_second[device_name] = 0
...
tokens_per_second[device_name] = int(num_tokens / time_taken)

print(f"Number of tokens: {num_tokens}", file=sys.stderr)
print(f"Time taken: {time_taken:.4f} seconds", file=sys.stderr)
print(f"Tokens per second: {tokens_per_second[device_name]}", file=sys.stderr)
print(f"Question: {question}", file=sys.stderr)
print(f"Answer: {answer}", file=sys.stderr)
print(json.dumps({"device": device_name, "tokens_per_second": tokens_per_second[device_name]}))
